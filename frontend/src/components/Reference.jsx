...
const Reference = () => {
  ...
  setForm({...form,title:location.state.val.title,
    ...
    function click1(){
     ...
     if(location.state==null){
      ...
      axiosInstance.post('http://localhost:3000/mentor/material/add',form)
  ...
  window.location.reload();
     ...
     const click2=(id)=>{
       ...
       axiosInstance.delete(`http://localhost:3000/mentor/material/del/${id}`)
      ...
      <TableBody>
        {data.map((row) => (
          ...
          >
            ...
            <Button className="deleteButton" onClick={()=>click2(row._id)}>
